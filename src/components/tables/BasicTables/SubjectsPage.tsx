...
export default function SemesterTable() {
  ...
  //   setShowForm(true);
  //   console.log('Add button clicked - showForm:', true); // Debug log
  // };

  // Edit semester - opens form with existing data
  // const handleEdit = (semester: Semester) => {
  //   console.log('Edit button clicked for semester:', semester.id); // Debug log
  ...
  //   });
  //   setShowForm(true);
  //   console.log('Edit form should be visible - showForm:', true); // Debug log
  // };
  ...
  const handleCancel = () => {
    ...
    setEditingSemester(null);
    setFormData({ semester_name: '', academic_year: '', subject: '' });
    console.log('Form cancelled - showForm:', false); // Debug log
  };

  const getSemesterDisplayName = (semesterName: string) => {
  ...
  console.log('Current state - showForm:', showForm, 'editingSemester:', editingSemester);
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add/Edit Form - Fixed to always show when showForm is true */}
      {showForm && (
